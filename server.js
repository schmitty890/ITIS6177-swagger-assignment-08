 ...
 */
 app.get('/api/v1/companies/:id', (req, res) => {
  ...
  .then(conn => {
    ...
    conn.query(`SELECT * FROM company WHERE COMPANY_ID='${req.params.id}'`)
      .then((rows) => {
        res.send(rows);
      })
      .then((res) => {
 ...
 */
 app.patch('/api/v1/companies/:id', (req, res) => {
  ...
  .then(conn => {
    ...
    if(name && city) {
      conn.query(`UPDATE company SET COMPANY_NAME='${name}', COMPANY_CITY='${city}' WHERE COMPANY_ID='${req.params.id}'`)
      .then((rows) => {
        res.send(rows);
      })
      .then((res) => {
      ...
      conn.query(`UPDATE company SET COMPANY_NAME='${name}' WHERE COMPANY_ID='${req.params.id}'`)
      .then((rows) => {
        res.send(rows);
      })
      .then((res) => {
      ...
      conn.query(`UPDATE company SET COMPANY_CITY='${city}' WHERE COMPANY_ID='${req.params.id}'`)
      .then((rows) => {
        res.send(rows);
      })
      .then((res) => {
 ...
 */
 app.post('/api/v1/companies', (req, res) => {
  ...
  .then(conn => {
    ...
    conn.query(`INSERT INTO company (COMPANY_ID, COMPANY_NAME, COMPANY_CITY) VALUES ('${COMPANY_ID}', '${COMPANY_NAME}', '${COMPANY_CITY}')`)
      .then((rows) => {
        res.send(rows);
      })
      .then((res) => {
 ...
 */
 app.put('/api/v1/companies/:id', (req, res) => {
  ...
  .then(conn => {
    ...
    conn.query(`UPDATE company SET COMPANY_NAME='${req.body.name}', COMPANY_CITY='${req.body.city}' WHERE COMPANY_ID='${req.params.id}'`)
      .then((rows) => {
        res.send(rows);
      })
      .then((res) => {
 ...
 */
 app.get('/api/v1/customer/:id', (req, res) => {
  ...
  .then(conn => {
    ...
    conn.query(`SELECT * FROM customer WHERE CUST_CODE='${req.params.id}'`)
      .then((rows) => {
        res.send(rows);
      })
      .then((res) => {
